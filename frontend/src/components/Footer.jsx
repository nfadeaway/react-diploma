      ...
      <div className="row">
        ...
        <div className="col text-right">
          <section className="footer-contacts">
            <h5>Контакты:</h5>
            <Link to="tel:+7-495-790-35-03" className="footer-contacts-phone">+7 495 79 03 5 03</Link>
            <span className="footer-contacts-working-hours">Ежедневно: с 09-00 до 21-00</span>
            <Link to="mailto:office@bosanoga.ru" className="footer-contacts-email">office@bosanoga.ru</Link>
